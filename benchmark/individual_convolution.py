...
def setUpModule():
    ...
    global g_window, all_history, g_input_size, g_mean, prediction_data, g_std
    ...
    prediction_data = dataset[-336:-168].to_numpy().reshape((1, 168, 15))
    prediction_label = dataset[-168:].to_numpy().reshape((1, 168, 15))
